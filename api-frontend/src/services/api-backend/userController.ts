...
/** updateMyUserCertificate POST /api/user/update/certificate */
export async function updateMyUserCertificateUsingPost(
  body: API.IdRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/user/update/certificate', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
